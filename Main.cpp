...
while(!ExempliReady()) {
  ...
  DWORD Crossfire = (DWORD)GetModuleHandle("crossfire.exe");
	...
	DWORD aIntersectSegment = FindPattern2(Crossfire, 0xFFFFFF,(PBYTE)"\x5D\xC3\xCC\x55\x8B\xEC\x8B\x45\x0C\x50\x8B\x4D\x08\x51\x8B\x15\x00\x00\x00\x00","0000000000000000????") - Crossfire;
  ...
  WeaponMgr 							= *(DWORD*)(WeaponMgr + 0x2) - CShell;
	...
	DWORD ModelNode 				= FindPattern2(CShell, 0xFFFFFF,(PBYTE)"\x8B\x0D\x00\x00\x00\x00\x83\xC4\x04\x89\x44\x0F\x54\x8B\x15\x00\x00\x00\x00\x8B\x04\x17\x3B\xC3\x7C\x0C\x83\xF8\x64\x7D\x07","00????000000000????000000000000");
  ...
  DWORD aILTClient        = FindPattern2(CShell, 0xFFFFFF,(PBYTE)"\x8B\x0D\x00\x00\x00\x00\x8B\x11\x8B\x82\x00\x00\x00\x00","00????0000????") - CShell;
  DWORD PTCOffset         = FindPattern2(CShell, 0xFFFFFF,(PBYTE)"\x8B\x88\x00\x00\x00\x00\x68\x00\x00\x00\x00\xFF\xD1\x8B\x0D\x00\x00\x00\x00\x8B\x11\x8B\x82\x00\x00\x00\x00","00????0????0000????0000????") - CShell;
